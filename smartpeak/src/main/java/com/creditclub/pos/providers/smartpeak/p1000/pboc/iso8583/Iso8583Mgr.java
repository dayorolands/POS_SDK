package com.creditclub.pos.providers.smartpeak.p1000.pboc.iso8583;
...
public class Iso8583Mgr {
    ...
    public Iso8583Mgr(Context context) {
        ...
        manager.Load8583XMLconfigByTag("ISO8583Config1");
        manager2 = new Iso8583Manager(context);
        manager2.Load8583XMLconfigByTag("ISO8583Config1");
    }
