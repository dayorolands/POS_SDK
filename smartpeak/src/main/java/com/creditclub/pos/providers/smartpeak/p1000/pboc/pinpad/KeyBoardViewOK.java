...
import com.creditclub.pos.providers.smartpeak.R;
...
public class KeyBoardViewOK implements ICupBaseView, OnClickListener {
	...
	public View getKeyBoardView() {
		...
		numok = parent.findViewById(R.id.num_ok);
		num0 = parent.findViewById(R.id.num0);
		num1 = parent.findViewById(R.id.num1);
		num2 = parent.findViewById(R.id.num2);
		num3 = parent.findViewById(R.id.num3);
		num4 = parent.findViewById(R.id.num4);
		num5 = parent.findViewById(R.id.num5);
		num6 = parent.findViewById(R.id.num6);
		num7 = parent.findViewById(R.id.num7);
		num8 = parent.findViewById(R.id.num8);
		num9 = parent.findViewById(R.id.num9);
		numBack = parent.findViewById(R.id.num_back);
		topLine = parent.findViewById(R.id.topline);
