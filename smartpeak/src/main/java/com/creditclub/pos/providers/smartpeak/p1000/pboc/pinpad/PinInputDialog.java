...
//		this.tx_amt.setText(amt);
	...
	public void initview() {
		...
		cardno = findViewById(R.id.tx_cardno);
		tx_amt_pre = findViewById(R.id.tx_amt_pre);
		tx_amt = findViewById(R.id.tx_amt);
		ll_close = findViewById(R.id.rl_close);
		...
		fl_keyboard = findViewById(R.id.fl_keyboard);
