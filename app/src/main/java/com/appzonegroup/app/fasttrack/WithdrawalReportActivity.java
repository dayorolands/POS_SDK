...
import com.appzonegroup.app.fasttrack.adapter.WithdrawalReportAdapter;
...
/**
 * Created by Oto-obong on 20/07/2017.
 */

public class WithdrawalReportActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void show_calendar() {
        ...
        final Dialog dialog = CalendarDialog.showCalendarDialog(WithdrawalReportActivity.this);
                ...
                .subscribe(new Subscriber<String>() {
                    ...
                    public void onNext(String result) {
                        ...
                        if (result.length() == 0)
                        {
                            ...
                            WithdrawalReportAdapter adapter2 = new WithdrawalReportAdapter(WithdrawalReportActivity.this, report.getReports());
                            ...
                            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                    ...
                                    final Dialog dialog = Dialogs.getDialog(R.layout.deposit_report_detail, WithdrawalReportActivity.this);
            ...
            public Observable<String> call() {
                ...
                try
                {
                    ...
                    String url = Misc.getReportURL(agentPhone,
                            institutionCode,
                            TransactionTypeName.CashOut.ordinal() + 1,
