...
public class AccountOpeningReportAdapter extends ArrayAdapter<ReportItem> {

    Activity activity;
    ArrayList<ReportItem> reportItems;
    public AccountOpeningReportAdapter(Activity activity, ArrayList<ReportItem> reportItems)
    {
