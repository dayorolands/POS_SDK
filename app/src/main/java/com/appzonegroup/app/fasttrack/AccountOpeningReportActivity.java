...
import com.appzonegroup.app.fasttrack.adapter.AccountOpeningReportAdapter;
...
public class AccountOpeningReportActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void show_calendar() {
        ...
        final Dialog dialog = CalendarDialog.showCalendarDialog(AccountOpeningReportActivity.this);
                ...
                .subscribe(new Subscriber<String>() {
                    ...
                    public void onNext(String result) {
                        ...
                        if (result.length() == 0)
                        {
                            ...
                            AccountOpeningReportAdapter adapter2 = new AccountOpeningReportAdapter(AccountOpeningReportActivity.this, report.getReports());
                            ...
                            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                    ...
                                    final Dialog dialog = Dialogs.getDialog(R.layout.open_account_report_detail, AccountOpeningReportActivity.this);
            ...
            public Observable<String> call() {
                ...
                try
                {
                    ...
                    String url = Misc.getReportURL(agentPhone,
                            institutionCode,
                            TransactionTypeName.Registration.ordinal() + 1,
