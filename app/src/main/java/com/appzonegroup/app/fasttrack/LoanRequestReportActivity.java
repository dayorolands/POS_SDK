...
public class LoanRequestReportActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void show_calendar() {
        ...
        final Dialog dialog = CalendarDialog.showCalendarDialog(LoanRequestReportActivity.this);
                ...
                .subscribe(new Subscriber<String>() {
                    ...
                    public void onNext(String result) {
                        ...
                        if (result.length() == 0)
                        {
                            ...
                            DepositReportAdapter adapter2 = new DepositReportAdapter(LoanRequestReportActivity.this, report.getReports());
                            ...
                            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                    ...
                                    final Dialog dialog = Dialogs.getDialog(R.layout.loan_report_detail, LoanRequestReportActivity.this);
