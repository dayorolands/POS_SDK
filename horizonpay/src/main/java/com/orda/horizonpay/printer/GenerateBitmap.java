package com.orda.horizonpay.printer;
...
public class GenerateBitmap {
     ...
     * @return
     */
    public static Bitmap str2Bitmap(String content, int textSize, AlignEnum align, Typeface font, boolean bold, boolean dispInvert) {
