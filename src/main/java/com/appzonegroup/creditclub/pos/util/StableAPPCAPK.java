...
//            Log("creat APP_VERVE database :" + dbResult);
    ...
    public static void Add_All_APP() {
        ...
        try {
            APP_Visa.AppName = "Visa".getBytes("ascii");
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        ...
        try {
            APP_Non_EMV.AppName = "Non_EMV".getBytes("ascii");
        ...
        try {
            APP_Test.AppName = "Test".getBytes("ascii");
        ...
        try {
            APP_ANO3.AppName = "ANO3".getBytes("ascii");
        ...
        try {
            APP_ANO4.AppName = "ANO4".getBytes("ascii");
        ...
        try {
            APP_ANO5.AppName = "ANO5".getBytes("ascii");
        ...
        try {
            APP_ANO6.AppName = "ANO6".getBytes("ascii");
        ...
        try {
            APP_ANO7.AppName = "ANO7".getBytes("ascii");
        ...
        try {
            APP_MasterCard.AppName = "Master Card".getBytes("ascii");
        ...
        try {
            APP_JCB.AppName = "JCB".getBytes("ascii");
        ...
        int i = result11;
        try {
            APP_Discover.AppName = "Discover".getBytes("ascii");
        ...
        try {
            APP_CUP_01.AppName = "China Union Pay".getBytes("ascii");
        ...
        try {
            APP_CUP_02.AppName = "China Union Pay".getBytes("ascii");
        ...
        try {
            APP_CUP_03.AppName = "China Union Pay".getBytes("ascii");
        ...
        try {
            APP_ANOD.AppName = "ANOD".getBytes("ascii");
        ...
        try {
            APP_ANOE.AppName = "ANOE".getBytes("ascii");
        ...
        try {
            APP_Visa.AppName = "Visa1".getBytes("ascii");
        ...
        try {
            APP_Visa.AppName = "Visa2".getBytes("ascii");
        ...
        try {
            APP_Visa.AppName = "Visa3".getBytes("ascii");
        ...
        try {
            APP_Visa.AppName = "Visa4".getBytes("ascii");
    ...
    static void addPaypassAid() {
        ...
        try {
            APP_1.AppName = "Mastercard".getBytes("ascii");
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        ...
        try {
            APP_12.AppName = "Maestro".getBytes("ascii");
        } catch (UnsupportedEncodingException e2) {
            e2.printStackTrace();
        }
        ...
        try {
            APP_13.AppName = "Test1".getBytes("ascii");
        } catch (UnsupportedEncodingException e3) {
            e3.printStackTrace();
        }
