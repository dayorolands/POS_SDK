...
//            dbResult = capkdbDao.create(capkdb);
    ...
    public static void Add_All_CAPK(){
        ...
        capk = new EmvCAPK();
        capk.RID = new byte[]{(byte) 0xA0, 0x00, 0x00, 0x03, 0x71};
        capk.KeyID = (byte) 0x04;
        capk.HashInd = (byte) 0x01;
        capk.ArithInd = (byte) 0x01;
        capk.Modul = StringUtil.hexStringToByte("");
        capk.Exponent = new byte[]{0x03};
        capk.ExpDate = new byte[]{0x17, 0x12, 0x31};
        capk.CheckSum = StringUtil.hexStringToByte("8B36A3E3D814CE6C6EBEAAF27674BB7BC67275B1");
        result = EmvService.Emv_AddCapk(capk);
        Log("Add CAPK capk_D1:" + result + " ID:" + capk.KeyID + "RID:"+ StringUtil.bytesToHexString(capk.RID));
        ...
        capk.HashInd = (byte) 0x01;
        capk.ArithInd = (byte) 0x01;
        capk.Modul = StringUtil.hexStringToByte("");
        capk.Exponent = new byte[]{0x03};
        capk.ExpDate = new byte[]{0x17, 0x12, 0x31};
        capk.CheckSum = StringUtil.hexStringToByte("319F3C608B67F1118C729B0E1516EAB07CB290C8");
        result = EmvService.Emv_AddCapk(capk);
        Log("Add CAPK capk_D1:" + result + " ID:" + capk.KeyID + "RID:"+ StringUtil.bytesToHexString(capk.RID));
        ...
        capk.HashInd = (byte) 0x01;
        capk.ArithInd = (byte) 0x01;
        capk.Modul = StringUtil.hexStringToByte("");
        capk.Exponent = new byte[]{0x03};
        capk.ExpDate = new byte[]{0x22, 0x12, 0x31};
        capk.CheckSum = StringUtil.hexStringToByte("676822D335AB0D2C3848418CB546DF7B6A6C32C0");
        result = EmvService.Emv_AddCapk(capk);
        Log("Add CAPK capk_D1:" + result + " ID:" + capk.KeyID + "RID:"+ StringUtil.bytesToHexString(capk.RID));
...
//            dbResult = aiddbDao.create(aiddb);
        ...
        name = "Verve";
        try {
            APP_VERVE.AppName = name.getBytes("ascii");
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
...
/*----------------------------------------------------------------------- division line-----------------------------------------------------------------------------------------*/
        ...
        capk_verve_01.KeyID = (byte) 0x04;
        capk_verve_01.HashInd = (byte) 0x01;
        capk_verve_01.ArithInd = (byte) 0x01;
        capk_verve_01.Modul = new byte[]{
                (byte) 0xD1,
                (byte) 0x3C, (byte) 0xD5, (byte) 0xE1, (byte) 0xB9, (byte) 0x21, (byte) 0xE4, (byte) 0xE0, (byte) 0xF0,
                (byte) 0xD4, (byte) 0x0E, (byte) 0x2D, (byte) 0xE1, (byte) 0x4C, (byte) 0xCE, (byte) 0x73, (byte) 0xE3,
                (byte) 0xA3, (byte) 0x4E, (byte) 0xD2, (byte) 0xDC, (byte) 0xFA, (byte) 0x82, (byte) 0x65, (byte) 0x31,
                (byte) 0xD8, (byte) 0x19, (byte) 0x56, (byte) 0x41, (byte) 0x09, (byte) 0x1E, (byte) 0x37, (byte) 0xC8,
                (byte) 0x47, (byte) 0x4D, (byte) 0x19, (byte) 0xB6, (byte) 0x86, (byte) 0xE8, (byte) 0x24, (byte) 0x3F,
                (byte) 0x08, (byte) 0x9A, (byte) 0x69, (byte) 0xF7, (byte) 0xB1, (byte) 0x8D, (byte) 0x2D, (byte) 0x34,
                (byte) 0xCB, (byte) 0x48, (byte) 0x24, (byte) 0xF2, (byte) 0x28, (byte) 0xF7, (byte) 0x75, (byte) 0x0F,
                (byte) 0x96, (byte) 0xD1, (byte) 0xEF, (byte) 0xBD, (byte) 0xFF, (byte) 0x88, (byte) 0x1F, (byte) 0x25,
                (byte) 0x9A, (byte) 0x8C, (byte) 0x04, (byte) 0xDE, (byte) 0x64, (byte) 0x91, (byte) 0x5A, (byte) 0x3A,
                (byte) 0x3D, (byte) 0x7C, (byte) 0xB8, (byte) 0x46, (byte) 0x13, (byte) 0x5F, (byte) 0x40, (byte) 0x83,
                (byte) 0xC9, (byte) 0x3C, (byte) 0xDE, (byte) 0x75, (byte) 0x5B, (byte) 0xC8, (byte) 0x08, (byte) 0x88,
                (byte) 0x6F, (byte) 0x60, (byte) 0x05, (byte) 0x42, (byte) 0xDF, (byte) 0xF0, (byte) 0x85, (byte) 0x55,
                (byte) 0x8D, (byte) 0x5E, (byte) 0xA7, (byte) 0xF4, (byte) 0x5C, (byte) 0xB1, (byte) 0x5E, (byte) 0xC8,
                (byte) 0x35, (byte) 0x06, (byte) 0x4A, (byte) 0xA8, (byte) 0x56, (byte) 0xD6, (byte) 0x02, (byte) 0xA0,
                (byte) 0xA4, (byte) 0x4C, (byte) 0xD0, (byte) 0x21, (byte) 0xF5, (byte) 0x4C, (byte) 0xF8, (byte) 0xEC,
                (byte) 0x0C, (byte) 0xC6, (byte) 0x80, (byte) 0xB5, (byte) 0x4B, (byte) 0x36, (byte) 0x65, (byte) 0xAB,
                (byte) 0xE7, (byte) 0x4A, (byte) 0x7C, (byte) 0x43, (byte) 0xD0, (byte) 0x28, (byte) 0x97, (byte) 0xFF,
                (byte) 0x84, (byte) 0xBB, (byte) 0x4C, (byte) 0xB9, (byte) 0x8B, (byte) 0xC9, (byte) 0x1D
        };
        capk_verve_01.Exponent = new byte[]{0x03};
        capk_verve_01.ExpDate = new byte[]{(byte)0x17, (byte)0x12, (byte)0x31};
        capk_verve_01.CheckSum = new byte[]{
                (byte) 0x8B, (byte) 0x36, (byte) 0xA3, (byte) 0xE3, (byte) 0xD8, (byte) 0x14, (byte) 0xCE, (byte) 0x6C, (byte) 0x6E, (byte) 0xBE, (byte) 0xAA, (byte) 0xF2, (byte) 0x76, (byte) 0x74, (byte) 0xBB, (byte) 0x7B, (byte) 0xC6, (byte) 0x72, (byte) 0x75, (byte) 0xB1
        };

        result = EmvService.Emv_AddCapk(capk_verve_01);
        Log("Add CAPK capk_verve_01:" + result + " ID:" + capk_verve_01.KeyID);
        ...
        capk_verve_02.KeyID = (byte) 0x03;
        capk_verve_02.HashInd = (byte) 0x01;
        capk_verve_02.ArithInd = (byte) 0x01;
        capk_verve_02.Modul = new byte[]{
                (byte) 0xd0,
                (byte) 0x62, (byte) 0x38, (byte) 0xb8, (byte) 0x56, (byte) 0xcf, (byte) 0x2c, (byte) 0x88, (byte) 0x90,
                (byte) 0xa7, (byte) 0xf6, (byte) 0x68, (byte) 0xca, (byte) 0x17, (byte) 0xc1, (byte) 0x92, (byte) 0x47,
                (byte) 0x49, (byte) 0x8d, (byte) 0x19, (byte) 0x3a, (byte) 0x7c, (byte) 0x11, (byte) 0xe7, (byte) 0x10,
                (byte) 0x5d, (byte) 0xed, (byte) 0xee, (byte) 0xe6, (byte) 0xa8, (byte) 0x73, (byte) 0xe8, (byte) 0x18,
                (byte) 0x9e, (byte) 0x50, (byte) 0x49, (byte) 0x3e, (byte) 0x9b, (byte) 0x17, (byte) 0x54, (byte) 0x7c,
                (byte) 0x42, (byte) 0xea, (byte) 0x4f, (byte) 0xa8, (byte) 0x8b, (byte) 0xbe, (byte) 0xf3, (byte) 0x0b,
                (byte) 0xb6, (byte) 0xbc, (byte) 0x24, (byte) 0x09, (byte) 0x24, (byte) 0x6c, (byte) 0xcc, (byte) 0x95,
                (byte) 0xf3, (byte) 0x66, (byte) 0x22, (byte) 0xa7, (byte) 0xf4, (byte) 0xd9, (byte) 0x2d, (byte) 0x46,
                (byte) 0x44, (byte) 0x4f, (byte) 0x20, (byte) 0xb1, (byte) 0xb2, (byte) 0x4b, (byte) 0xf6, (byte) 0x3c,
                (byte) 0x5b, (byte) 0x28, (byte) 0x39, (byte) 0x5d, (byte) 0x8e, (byte) 0xf1, (byte) 0x8c, (byte) 0x23,
                (byte) 0x20, (byte) 0x5c, (byte) 0x21, (byte) 0x19, (byte) 0xdf, (byte) 0xe5, (byte) 0xfb, (byte) 0xa2,
                (byte) 0xfb, (byte) 0xfc, (byte) 0x31, (byte) 0x1b, (byte) 0x2f, (byte) 0xe8, (byte) 0xa6, (byte) 0xa7,
                (byte) 0x5b, (byte) 0x35, (byte) 0xa7, (byte) 0xda, (byte) 0xb7, (byte) 0x2d, (byte) 0x42, (byte) 0x17,
                (byte) 0x92, (byte) 0xa5, (byte) 0x00, (byte) 0xcd, (byte) 0xfd, (byte) 0x81, (byte) 0x33, (byte) 0xb8,
                (byte) 0xa9, (byte) 0x7d, (byte) 0x84, (byte) 0xa4, (byte) 0x9c, (byte) 0x0b, (byte) 0xd2, (byte) 0x2d,
                (byte) 0x52, (byte) 0xd0, (byte) 0x6e, (byte) 0xa5, (byte) 0xe0, (byte) 0xef, (byte) 0x3e, (byte) 0x47,
                (byte) 0x1d, (byte) 0x47, (byte) 0xd8, (byte) 0x37, (byte) 0x0c, (byte) 0x37, (byte) 0xaa, (byte) 0x48,
                (byte) 0xb5, (byte) 0x64, (byte) 0x68, (byte) 0x9d, (byte) 0x00, (byte) 0x35, (byte) 0xd9
        };
        capk_verve_02.Exponent = new byte[]{0x03};
        capk_verve_02.ExpDate = new byte[]{(byte)0x17, (byte)0x12, (byte)0x31};
        capk_verve_02.CheckSum = new byte[]{
                (byte) 0x31,
                (byte) 0x9F, (byte) 0x3C, (byte) 0x60, (byte) 0x8B, (byte) 0x67, (byte) 0xF1, (byte) 0x11, (byte) 0x8C,
                (byte) 0x72, (byte) 0x9B, (byte) 0x0E, (byte) 0x15, (byte) 0x16, (byte) 0xEA, (byte) 0xB0, (byte) 0x7C,
                (byte) 0xB2, (byte) 0x90, (byte) 0xC8
        };

        result = EmvService.Emv_AddCapk(capk_verve_02);
        Log("Add CAPK capk_verve_02:" + result + " ID:" + capk_verve_02.KeyID);
        ...
        EmvCAPK capk_verve_03 = new EmvCAPK();
        capk_verve_03.RID = new byte[]{(byte) 0xA0, (byte) 0x00, (byte) 0x00, (byte) 0x03, (byte) 0x71};
        capk_verve_03.KeyID = (byte) 0x05;
        capk_verve_03.HashInd = (byte) 0x01;
        capk_verve_03.ArithInd = (byte) 0x01;
        capk_verve_03.Modul = new byte[]{
                (byte) 0xB0,
                (byte) 0x36, (byte) 0xA8, (byte) 0xCA, (byte) 0xE0, (byte) 0x59, (byte) 0x3A, (byte) 0x48, (byte) 0x09,
                (byte) 0x76, (byte) 0xBF, (byte) 0xE8, (byte) 0x4F, (byte) 0x8A, (byte) 0x67, (byte) 0x75, (byte) 0x9E,
                (byte) 0x52, (byte) 0xB3, (byte) 0xD9, (byte) 0xF4, (byte) 0xA6, (byte) 0x8C, (byte) 0xCC, (byte) 0x37,
                (byte) 0xFE, (byte) 0x72, (byte) 0x0E, (byte) 0x59, (byte) 0x4E, (byte) 0x56, (byte) 0x94, (byte) 0xCD,
                (byte) 0x1A, (byte) 0xE2, (byte) 0x0E, (byte) 0x1B, (byte) 0x12, (byte) 0x0D, (byte) 0x7A, (byte) 0x18,
                (byte) 0xFA, (byte) 0x5C, (byte) 0x70, (byte) 0xE0, (byte) 0x44, (byte) 0xD3, (byte) 0xB1, (byte) 0x2E,
                (byte) 0x93, (byte) 0x2C, (byte) 0x9B, (byte) 0xBD, (byte) 0x9F, (byte) 0xDE, (byte) 0xA4, (byte) 0xBE,
                (byte) 0x11, (byte) 0x07, (byte) 0x1E, (byte) 0xF8, (byte) 0xCA, (byte) 0x3A, (byte) 0xF4, (byte) 0x8F,
                (byte) 0xF2, (byte) 0xB5, (byte) 0xDD, (byte) 0xB3, (byte) 0x07, (byte) 0xFC, (byte) 0x75, (byte) 0x2C,
                (byte) 0x5C, (byte) 0x73, (byte) 0xF5, (byte) 0xF2, (byte) 0x74, (byte) 0xD4, (byte) 0x23, (byte) 0x8A,
                (byte) 0x92, (byte) 0xB4, (byte) 0xFC, (byte) 0xE6, (byte) 0x6F, (byte) 0xC9, (byte) 0x3D, (byte) 0xA1,
                (byte) 0x8E, (byte) 0x6C, (byte) 0x1C, (byte) 0xC1, (byte) 0xAA, (byte) 0x3C, (byte) 0xFA, (byte) 0xFC,
                (byte) 0xB0, (byte) 0x71, (byte) 0xB6, (byte) 0x7D, (byte) 0xAA, (byte) 0xCE, (byte) 0x96, (byte) 0xD9,
                (byte) 0x31, (byte) 0x4D, (byte) 0xB4, (byte) 0x94, (byte) 0x98, (byte) 0x2F, (byte) 0x5C, (byte) 0x96,
                (byte) 0x7F, (byte) 0x69, (byte) 0x8A, (byte) 0x05, (byte) 0xE1, (byte) 0xA8, (byte) 0xA6, (byte) 0x9D,
                (byte) 0xA9, (byte) 0x31, (byte) 0xB8, (byte) 0xE5, (byte) 0x66, (byte) 0x27, (byte) 0x0F, (byte) 0x04,
                (byte) 0xEA, (byte) 0xB5, (byte) 0x75, (byte) 0xF5, (byte) 0x96, (byte) 0x71, (byte) 0x04, (byte) 0x11,
                (byte) 0x8E, (byte) 0x4F, (byte) 0x12, (byte) 0xAB, (byte) 0xFF, (byte) 0x9D, (byte) 0xEC, (byte) 0x92,
                (byte) 0x37, (byte) 0x9C, (byte) 0xD9, (byte) 0x55, (byte) 0xA1, (byte) 0x06, (byte) 0x75, (byte) 0x28,
                (byte) 0x2F, (byte) 0xE1, (byte) 0xB6, (byte) 0x0C, (byte) 0xAD, (byte) 0x13, (byte) 0xF9, (byte) 0xBB,
                (byte) 0x80, (byte) 0xC2, (byte) 0x72, (byte) 0xA4, (byte) 0x0B, (byte) 0x6A, (byte) 0x34, (byte) 0x4E,
                (byte) 0xA6, (byte) 0x99, (byte) 0xFB, (byte) 0x9E, (byte) 0xFA, (byte) 0x68, (byte) 0x67
        };
        capk_verve_03.Exponent = new byte[]{0x03};
        capk_verve_03.ExpDate = new byte[]{ (byte) 0x22, (byte) 0x12, (byte) 0x31};
        capk_verve_03.CheckSum = new byte[]{
                (byte) 0x67,
                (byte) 0x68, (byte) 0x22, (byte) 0xD3, (byte) 0x35, (byte) 0xAB, (byte) 0x0D, (byte) 0x2C, (byte) 0x38,
                (byte) 0x48, (byte) 0x41, (byte) 0x8C, (byte) 0xB5, (byte) 0x46, (byte) 0xDF, (byte) 0x7B, (byte) 0x6A,
                (byte) 0x6C, (byte) 0x32, (byte) 0xC0
        };

        result = EmvService.Emv_AddCapk(capk_verve_03);
        Log("Add CAPK capk_verve_03:" + result + " ID:" + capk_verve_03.KeyID);
