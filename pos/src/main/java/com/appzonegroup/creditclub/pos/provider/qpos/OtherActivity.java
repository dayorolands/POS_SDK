...
import com.appzonegroup.creditclub.pos.provider.qpos.injectKey.DukptKeys;
import com.appzonegroup.creditclub.pos.provider.qpos.injectKey.Envelope;
import com.appzonegroup.creditclub.pos.provider.qpos.injectKey.Poskeys;
import com.appzonegroup.creditclub.pos.provider.qpos.injectKey.TMKKey;
import com.appzonegroup.creditclub.pos.provider.qpos.utils.ConfigUtil;
import com.appzonegroup.creditclub.pos.provider.qpos.utils.DUKPK2009_CBC;
import com.appzonegroup.creditclub.pos.provider.qpos.utils.FileUtils;
import com.appzonegroup.creditclub.pos.provider.qpos.utils.TLV;
import com.appzonegroup.creditclub.pos.provider.qpos.utils.TLVParser;
...
//					pos.bypassPin();
        ...
        public void onReturnUpdateEMVRIDResult(boolean arg0) {
            ...
            if (arg0) {
                ...
                ConfigUtil.putReadXmlStatus(mContext, false);
            }
        }
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 1704:
                    if (appTLVList == null){
                        String mEmvAppCfg = QPOSUtil.byteArray2Hex(FileUtils.readAssetsLine("emv_app.bin",mContext));
                ...
                case 1705:
                    if (capkTLVList == null){
                        String mEmvCapkCfg = QPOSUtil.byteArray2Hex(FileUtils.readAssetsLine("emv_capk.bin",mContext));
