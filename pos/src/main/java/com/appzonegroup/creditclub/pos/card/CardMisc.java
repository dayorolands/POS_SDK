...
import com.appzonegroup.creditclub.pos.util.AID;
...
public class CardMisc {
    ...
    public static String getCardPAN(String data) {
        ...
        for (int i = 0; i < arrayedHex.length; i++)// (String hex : arrayedHex)
        {
            ...
            if (indexFound) {
                ...
                StringBuilder returnData = new StringBuilder();
                while (count < length) {
                    if (startIndex >= arrayedHex.length) return null;
    ...
    public static String getReadCommand(int index) {
        switch (index) {
            case 1:
                return "00 c0 00 00 ";//VISA
            case 0:
                return "00 b2 04 0c ";//VERVE
            case 2:
            default:
                return "00 b2 01 14 ";//MasterCard
        }
    }
    ...
    public static int hexToDecimal(String hexaString) {
