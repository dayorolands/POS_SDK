...
public final class EmvUtil {
     ...
     * Initialize keys
     */
    public static void initKey(SunmiPayKernel payKernel) {
        try {
            SecurityOptV2 mSecurityOptV2 = payKernel.mSecurityOptV2;
     ...
     */
    public static void initAidAndRid(SunmiPayKernel payKernel) {
        try {
            EMVOptV2 emvOptV2 = payKernel.mEMVOptV2;
            //Normal AIDs
     ...
     */
    public static void setTerminalParam(SunmiPayKernel payKernel, Map<String, String> map) {
        try {
            EMVOptV2 emvOptV2 = payKernel.mEMVOptV2;
